...
//--Check for project flow when query replied by PI for initial submision for MS decisions--//
public class TS_164 {
	...
	// --Check for project flow when query replied by PI for initial submission get MS decision as 'Letter of Permission'--//
	...
	//***********Submit query related documents and flow till MS decision************//
		...
		for (int i =gp.querydoccount; i<=docvalue2.size()-1; i++)
		{
		...
		WebElement query_replied_dashboard = GWait.Wait_GetElementByXpath("//li[4]/a/span");
		...
		WebElement query_replied_dashboard1 = GWait.Wait_GetElementByXpath("//li[4]/a/span");
		...
		//**************After Letter of Permission, checking overview and submit new documents option***********//
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Disapproval Letter'--//
	...
	//**************After Disapproval Letter, checking overview and submit new documents option***********//
		...
		gp.Global_PILoginstatus_Verify_Archived("Pushpa Project_1213_to_1220", "Disapproved","Query Reply", "Disapproved");
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Provisional Letter of Permission'--//
...
//*****************Checking Edit Option after provinsional letter of permission****************//
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Under IEC Review", "Query Reply", "Provisional Permission");
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Query Letter – MS'--//
	...
	//***********Submit query related documents and flow till MS decision************
        ...
        Thread.sleep(2000);
		WebElement ethic_comments = GWait.Wait_GetElementByClassName("richText");
		ethic_comments.sendKeys("Test Comments");
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220", "Under IEC Review", "Query Reply", "Query - Member Secretary");
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Query Letter – Full Board'--//
	...
	//***********Submit query related documents and flow till MS decision************
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220", "Under IEC Review", "Query Reply", "Query - Full Board");
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Query Letter – Reviewers--//
	...
	//***********Submit query related documents and flow till MS decision************
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220", "Under IEC Review", "Query Reply", "Query - Primary Reviewer");
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Withdrawn letter'--//
	...
	// --Check project flow when query replied by PI for initial submission get MS decision as 'Termination letter'--//
	...
	//***********Submit query related documents and flow till MS decision************
		...
		WebElement ethic_comments = GWait.Wait_GetElementByClassName("richText-editor");
		ethic_comments.sendKeys(ethic_comnts);
