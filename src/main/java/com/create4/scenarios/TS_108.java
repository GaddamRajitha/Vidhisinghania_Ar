...
/*
 * Check for 'Announcement' section feature functionality in PI dashboard
 */
public class TS_108 {
	...
	public void CRe4_408_409_410_411_412() throws Exception {
		...
		String announce_title = r1.getCell(2, 5).getContents();
		String announce_desc = r1.getCell(3, 5).getContents();
		String announce_file = r1.getCell(4, 5).getContents();
		String announce_date = r1.getCell(5, 5).getContents();
		String announce_acknowledge = r1.getCell(6, 5).getContents();
