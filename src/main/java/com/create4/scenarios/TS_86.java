...
//Check for termination 'Document status' until MS decision in PI
public class TS_86 {
	...
	public void CRe4_1593_96_98_60() throws Exception {
		...
		String Decision_LOP = r1.getCell(26, 231).getContents();
		String Decisionfile = r1.getCell(27, 231).getContents();
		String Decisioncmnt = r1.getCell(28, 231).getContents();

		// Document upload data
		String Document_Title_in_list = r1.getCell(7, 231).getContents();
		String Version_in_list = r1.getCell(8, 231).getContents();
		String Document_Date_in_list = r1.getCell(9, 231).getContents();
		String doc_upload = r1.getCell(10, 231).getContents();
		...
		g5.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Submitted to IEC");
		GlobalMethods.Admin_Login();
		g5.Global_Dashboard_PrematureTerminationLink();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Submitted to IEC");
		g5.SubsequentSubmissions_IECAdmin_forwardto_MS();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","MS Review");
		...
		g5.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Under IEC Review");
		GlobalMethods.MS_Login();
		g5.Global_Dashboard_PrematureTerminationLink();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","MS Review");
		g5.MS_ForwardTo_CP();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Chairperson Review");
