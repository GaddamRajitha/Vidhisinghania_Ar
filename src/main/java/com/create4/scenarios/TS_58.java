...
//Check for sae followup submission project status for all MS decisions
public class TS_58 {
	...
	// Check for 'Project status' when SAE Follow up report submission gets MS decision as 'Noted Letter'
	public void CRe4_1749() throws Exception 
	{
		...
		String Document_Title_in_list = r1.getCell(7,103).getContents();
		String Version_in_list = r1.getCell(8,103).getContents();
		String Document_Date_in_list = r1.getCell(9,103).getContents();
		String doc_upload = r1.getCell(10,103).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,103).getContents();
		String Decisionfile = r1.getCell(34,103).getContents();
		String Decisioncmnt = r1.getCell(32,103).getContents();

		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,103).getContents();
		String sae_report_type_1 = r1.getCell(14,103).getContents();
		String sae_number_1 = r1.getCell(16,103).getContents();
		String sae_patient_initial_1 = r1.getCell(17,103).getContents();
		String sae_report_type_2 = r1.getCell(15,103).getContents();
		String sae_doc_date_1 = r1.getCell(18,103).getContents();
		...
		String Decision_LOP1 = r11.getCell(33,103).getContents();
		String Decisionfile1 = r11.getCell(34,103).getContents();
		String Decisioncmnt1 = r11.getCell(35,103).getContents();
	...
	// Check for 'Project status' when SAE Follow up report submission gets MS decision as 'Query Letter'
	public void CRe4_1754() throws Exception {
		...
		// Document upload data
		String Document_Title_in_list = r1.getCell(7,105).getContents();
		String Version_in_list = r1.getCell(8,105).getContents();
		String Document_Date_in_list = r1.getCell(9,105).getContents();
		String doc_upload = r1.getCell(10,105).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,105).getContents();
		String Decisionfile = r1.getCell(34,105).getContents();
		String Decisioncmnt = r1.getCell(32,105).getContents();

		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,105).getContents();
		String sae_report_type_1 = r1.getCell(14,105).getContents();
		String sae_number_1 = r1.getCell(16,105).getContents();
		String sae_patient_initial_1 = r1.getCell(17,105).getContents();
		String sae_report_type_2 = r1.getCell(15,105).getContents();
		String sae_doc_date_1 = r1.getCell(18,105).getContents();
		...
		String Decision_LOP1 = r11.getCell(33,105).getContents();
		String Decisionfile1 = r11.getCell(34,105).getContents();
		String Decisioncmnt1 = r11.getCell(35,105).getContents();
	...
	// Check for 'Project status' when SAE Follow up report submission gets MS decision as 'Termination Letter'
	public void CRe4_1807() throws Exception {
		...
		// Document upload data
		String Document_Title_in_list = r1.getCell(7,107).getContents();
		String Version_in_list = r1.getCell(8,107).getContents();
		String Document_Date_in_list = r1.getCell(9,107).getContents();
		String doc_upload = r1.getCell(10,107).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,107).getContents();
		String Decisionfile = r1.getCell(34,107).getContents();
		String Decisioncmnt = r1.getCell(32,107).getContents();

		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,107).getContents();
		String sae_report_type_1 = r1.getCell(14,107).getContents();
		String sae_number_1 = r1.getCell(16,107).getContents();
		String sae_patient_initial_1 = r1.getCell(17,107).getContents();
		String sae_report_type_2 = r1.getCell(15,107).getContents();
		String sae_doc_date_1 = r1.getCell(18,107).getContents();
		...
		//*********************Login with MS and upload the decision as "Termination Letter" **********************

		FileInputStream fi1 = new FileInputStream("C:\\Selenium_Files\\Create4_v2\\CReATE4_Data.xls");
		Workbook wb1 = Workbook.getWorkbook(fi1);
		Sheet r11 = wb1.getSheet("Project Submissions");

		String Decision_LOP1 = r11.getCell(33,107).getContents();
		String Decisionfile1 = r11.getCell(34,107).getContents();
		String Decisioncmnt1 = r11.getCell(35,107).getContents();
		...
		gp.Global_PILoginstatus_Verify_Archived("Pushpa Project_1213_to_1220","Archived","SAE","Terminated");
		
			
	
	}

	// Check for 'Project status' when SAE Follow up report submission gets MS decision as 'Suspension letter'
	public void CRe4_1812() throws Exception {
		...
		// Document upload data
		String Document_Title_in_list = r1.getCell(7,109).getContents();
		String Version_in_list = r1.getCell(8,109).getContents();
		String Document_Date_in_list = r1.getCell(9,109).getContents();
		String doc_upload = r1.getCell(10,109).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,109).getContents();
		String Decisionfile = r1.getCell(34,109).getContents();
		String Decisioncmnt = r1.getCell(32,109).getContents();

		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,109).getContents();
		String sae_report_type_1 = r1.getCell(14,109).getContents();
		String sae_number_1 = r1.getCell(16,109).getContents();
		String sae_patient_initial_1 = r1.getCell(17,109).getContents();
		String sae_report_type_2 = r1.getCell(15,109).getContents();
		String sae_doc_date_1 = r1.getCell(18,109).getContents();
		...
		String Decision_LOP1 = r11.getCell(33,109).getContents();
		String Decisionfile1 = r11.getCell(34,109).getContents();
		String Decisioncmnt1 = r11.getCell(35,109).getContents();
