...
//Check for continuing 'Document status' until MS decision in PI
public class TS_84 {
	...
	// Check for 'Document status' when Continuing review submitted to IEC
	public void CRe4_1435_38_40_42() throws Exception {

		//******************Initial Project Submission********************//

		Global_Project_Submissions g4=new Global_Project_Submissions();
		g4.PI_SubmitProject_IECAdmin();
		g4.After_PI_Submits_IEC_Statusin_PI();
		g4.Dashboard_Click_Admin();
		g4.InitialSubmission_StatusinAdmin_Starting();
		g4.Admin_Forwardto_MS();
		g4.InitialSubmission_StatusinAdmin_Ending();
		g4.InitialSub_After__IEC_forwardto_MS_StatusInPI();
		g4.MS_Dashboard_Click();
		g4.InitialSubmission_StatusinMS_Starting();
		g4.MS_ForwardTo_CP();
		g4.InitialSubmission_StatusinMS_Ending();
		g4.InitialSub_After__MS_forwardto_CP_StatusInPI();
		g4.CP_DashboardClick();
		g4.InitialSubmission_StatusinCP_Starting();
		g4.CP_SubmitProjectTo_MS();
		g4.InitialSubmission_StatusinCP_Ending();
		g4.InitialSub_After__CP_Submitto_MS_StatusInPI();
		g4.StatusIn_MS_After_CPSubmitsToMS();
		...
		String Decision_LOP = r1.getCell(26, 227).getContents();
		String Decisionfile = r1.getCell(27, 227).getContents();
		String Decisioncmnt = r1.getCell(28, 227).getContents();

		// Document upload data
		
		String Document_Title_in_list = r1.getCell(7, 227).getContents();
		String Version_in_list = r1.getCell(8, 227).getContents();
		String Document_Date_in_list = r1.getCell(9, 227).getContents();
		String doc_upload = r1.getCell(10, 227).getContents();
		...
		g4.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Submitted to IEC");
		GlobalMethods.Admin_Login();
		g4.Global_Dashboard_ContinuationLink();
		g4.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Submitted to IEC");
		g4.SubsequentSubmissions_IECAdmin_forwardto_MS();
		g4.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","MS Review");
		...
		g4.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Under IEC Review");
		GlobalMethods.MS_Login();
		g4.Global_Dashboard_ContinuationLink();
		g4.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","MS Review");
		g4.MS_ForwardTo_CP();
		g4.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		g4.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Chairperson Review");
