...
//Check for sae other 'Document status' until MS decision in PI
public class TS_89 {
	...
	public void CRe4_1820_23_25_27() throws Exception {
		...
		Global_Project_Submissions g9=new Global_Project_Submissions();
		g9.PI_SubmitProject_IECAdmin();
		g9.After_PI_Submits_IEC_Statusin_PI();
		g9.Dashboard_Click_Admin();
		g9.InitialSubmission_StatusinAdmin_Starting();
		g9.Admin_Forwardto_MS();
		g9.InitialSubmission_StatusinAdmin_Ending();
		g9.InitialSub_After__IEC_forwardto_MS_StatusInPI();
		g9.MS_Dashboard_Click();
		g9.InitialSubmission_StatusinMS_Starting();
		g9.MS_ForwardTo_CP();
		g9.InitialSubmission_StatusinMS_Ending();
		g9.InitialSub_After__MS_forwardto_CP_StatusInPI();
		g9.CP_DashboardClick();
		g9.InitialSubmission_StatusinCP_Starting();
		g9.CP_SubmitProjectTo_MS();
		g9.InitialSubmission_StatusinCP_Ending();
		g9.InitialSub_After__CP_Submitto_MS_StatusInPI();
		g9.StatusIn_MS_After_CPSubmitsToMS();
		...
		String Decision_LOP = r1.getCell(26, 237).getContents();
		String Decisionfile = r1.getCell(27, 237).getContents();
		String Decisioncmnt = r1.getCell(28, 237).getContents();
		

		// Document upload data
		String Document_Title_in_list = r1.getCell(7, 237).getContents();
		String Version_in_list = r1.getCell(8, 237).getContents();
		String Document_Date_in_list = r1.getCell(9, 237).getContents();
		String doc_upload = r1.getCell(10, 237).getContents();
		
		// SAE submission data

		String sae_site_type_2 = r1.getCell(31, 237).getContents();
		String sae_number_1 = r1.getCell(32, 237).getContents();
		String sae_patient_initial_1 = r1.getCell(33, 237).getContents();
		...
		g9.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Submitted to IEC");
		GlobalMethods.Admin_Login();
		g9.Global_Dashboard_SAE();
		g9.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Submitted to IEC");
		g9.SubsequentSubmissions_IECAdmin_forwardto_MS();
		g9.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","MS Review");
		...
		g9.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Under IEC Review");
		GlobalMethods.MS_Login();
		g9.Global_Dashboard_SAE();
		g9.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","MS Review");
		g9.MS_ForwardTo_CP();
		g9.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		g9.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Chairperson Review");
