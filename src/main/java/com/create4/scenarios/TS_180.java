...
//Check for Submission status when query replied by Pi for�continuing submission for MS decisions
public class TS_180 extends TS_54 {
	...
	//continuing form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as 'Letter of Permission'
	 public void CRe4_1466_1467_1468() throws Exception{

		 
	     //***********Initial project submission with LOP decision and continuing gets decision as Query-MS**********/
		 
		  CRe4_1453();
		 
		 System.out.println(querydocount);
		 ...
		 for (int i=querydocount; i<=docvalue2.size()-1; i++)
		 {
		 ...
		 WebElement logouttH = GWait.Wait_GetElementByXpath("//span[3]/a");
		 logouttH.click();
		 WebElement logoH = GWait.Wait_GetElementByCSS("img");
		 logoH.click();
		...
		//*******************Check for the remaining document flow after the MS decision as letter of permission*************//
			...
			WebElement MyProjLink = GWait.Wait_GetElementByLinkText("My Projects");
			MyProjLink.click();
...
//		Check submission status when query replied by PI for continuing submission get MS decision as 'Disapproval Letter'
	 public void CRe4_1476_1477_1478() throws Exception{
        ...
        TS_54 obj=new TS_54();
		 ...
		 System.out.println(docvalue2.size()-1);
		 System.out.println("QUERY"+obj.querydocount);
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for continuing submission get MS decision as 'Query Letter � MS'
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as 'Query Letter � Full Board'
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as 'Query Letter � Reviewers'
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as 'Withdrawal letter''
	 ...
	 //Check submission status when query replied by PI for continuing submission get MS decision as Termination letter'
	 public void CRe4_1506_1507_1508() throws Exception{
		 ...
		 gp.Global_PILoginstatus_Verify_Archived("Pushpa Project_1213_to_1220", "Archieved", "Query Reply", "Terminated");
