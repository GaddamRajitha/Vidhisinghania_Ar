...
//Check for project delete functionality in PI
...
public class TS_154 {
		...
		//Check for action as 'Delete project' in project list
		public void CRe4_2081_2082() throws Exception {
			...
			String Project_Type = r1.getCell(2, 83).getContents();
		    String Review_Type_fullboard = r1.getCell(3, 83).getContents();
			String Project_Full_Title = r1.getCell(4, 83).getContents();
			String Project_Short_Title = r1.getCell(5, 83).getContents();
			String Sponsor = r1.getCell(6, 83).getContents();

			String Document_Title_in_list = r1.getCell(7, 83).getContents();
			String Version_in_list = r1.getCell(8, 83).getContents();
			String doc_upload = r1.getCell(9, 83).getContents();
			String Document_Date_in_list = r1.getCell(10, 83).getContents();
			...
			WebElement delete_project =GWait.Wait_GetElementByCSS("span.fa.fa-minus-circle");
			...
			Assert.assertEquals(delete_project_acknowledge.getText().trim(), "Project has been deleted.");
