...
//Check for 'Upcoming meeting'  section feature functionality in�Member�Secretary�dashboard
public class TS_117 {
	...
	public void CRe4_506_to_510() throws Exception{
		...
		String Upcoming_Meetings = r1.getCell(2, 25).getContents();

		String date = r1.getCell(3, 25).getContents();
		String venu = r1.getCell(4, 25).getContents();

		String meetingsheading = r1.getCell(5, 25).getContents();
		String date_field = r1.getCell(6, 25).getContents();
		String meeting_field = r1.getCell(7, 25).getContents();
