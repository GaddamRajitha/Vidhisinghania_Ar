...
public class TS_14A {
	...
	public void AddQualification_CRe4_928_CRe4_921_CRe4_929() throws Exception {
			...
			Manage_IECA1.click();
			WebElement Manage_Qualifications1=GWait.Wait_GetElementByLinkText("Manage Qualifications");
			...
			WebElement QulifiValue1=GWait.Wait_GetElementByXpath("//td[contains(text(),"+Qualification_Data+")]");
