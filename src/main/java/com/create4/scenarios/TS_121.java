...
/*
 * Check for 'Ongoing projects' section feature functionality in Chairperson dashboard
 */
public class TS_121 {
	...
	public void CRe4_533_to_51() throws Exception{
		...
		String Approved = r1.getCell(2, 31).getContents();
		String Project_Continuous_Request = r1.getCell(3, 31).getContents();
		String Project_Completion_Request = r1.getCell(4, 31).getContents();
		String Queries_Replied = r1.getCell(5, 31).getContents();
		String Projects_Termination = r1.getCell(6, 31).getContents();
		String Amendments = r1.getCell(7, 31).getContents();
		String Deviations = r1.getCell(8, 31).getContents();
		String SAE = r1.getCell(9, 31).getContents();
		String Other_Submissions = r1.getCell(10, 31).getContents();
