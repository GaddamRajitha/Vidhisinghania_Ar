...
//Check for Submission status when query replied by Pi for amendment submission for MS decisions
public class TS_177 extends TS_52 {
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as 'Letter of Permission'
	 public void CRe4_1341() throws Exception{
		 
	     //***********Initial project submission with LOP decision and amendment gets decision as Query-MS**********//
...
//		Check submission status when query replied by PI for amendment submission get MS decision as 'Disapproval Letter'
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for amendment submission get MS decision as 'Query Letter – MS'
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as 'Query Letter – Full Board'
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as 'Query Letter – Reviewers'
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as 'Withdrawal letter''
	 ...
	 //Check submission status when query replied by PI for amendment submission get MS decision as Termination letter'
