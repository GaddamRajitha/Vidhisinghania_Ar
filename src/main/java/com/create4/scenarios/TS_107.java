...
public class TS_107 {
	...
	// Project notification elements

	@FindBy(xpath = "//td/a")
	WebElement dashprojectnumberclick;

	@FindBy(linkText = "Dashboard")
	WebElement dashboardmenulink;

	@FindBy(css = "td.text-black")
	WebElement dashprojectlettertext;

	@FindBy(linkText = "View all")
	WebElement dashviewall;

	@FindBy(css = "h3")
	WebElement projectnotifheading;
