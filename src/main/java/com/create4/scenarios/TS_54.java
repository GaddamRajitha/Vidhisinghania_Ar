...
//Check for continuing submission project status for all MS decisions
public class TS_54 {
	public TS_54() {
	...
	// Check for 'Project status' when Continuing submission gets MS decision as 'Noted Letter'
	...
	public void CRe4_1443() throws Exception {
		...
		String Decision_LOP = r1.getCell(11, 75).getContents();
		String Decisionfile = r1.getCell(28, 75).getContents();
		String Decisioncmnt = r1.getCell(29, 75).getContents();
		...
		//**************************Normal Flow after Continuation document*****************************

		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Submitted to IEC");
		GlobalMethods.Admin_Login();
		gp.Global_Dashboard_ContinuationLink();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Submitted to IEC");
		gp.SubsequentSubmissions_IECAdmin_forwardto_MS();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","MS Review");
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Under IEC Review");
		GlobalMethods.MS_Login();
		gp.Global_Dashboard_ContinuationLink();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","MS Review");
		gp.MS_ForwardTo_CP();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Chairperson Review");
		...
		String Decision_LOP1 = r11.getCell(30,75).getContents();
		String Decisionfile1 = r11.getCell(31,75).getContents();
		String Decisioncmnt1 = r11.getCell(32,75).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Noted");
		
	}

	// Check for 'Project status' when Continuing submission gets MS decision as 'revoke approval Letter'
	...
	public void CRe4_1448() throws Exception {
		...
		String Decision_LOP = r1.getCell(11, 77).getContents();
		String Decisionfile = r1.getCell(28, 77).getContents();
		String Decisioncmnt = r1.getCell(29, 77).getContents();
		...
		//*********************Login with MS and upload the decision as "revoke approval Letter'"**********************

		FileInputStream fi1 = new FileInputStream("C:\\Selenium_Files\\Create4_v2\\CReATE4_Data.xls");
		Workbook wb1 = Workbook.getWorkbook(fi1);
		Sheet r11 = wb1.getSheet("Project Submissions");

		String Decision_LOP1 = r11.getCell(30,77).getContents();
		String Decisionfile1 = r11.getCell(31,77).getContents();
		String Decisioncmnt1 = r11.getCell(32,77).getContents();
		...
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Archived","Continuation","Terminated");

	}

	// Check for 'Project status' when Continuing submission gets MS decision as 'Query Letter – Full Board'
	public void CRe4_1453() throws Exception {
		...
		String Decision_LOP = r1.getCell(11, 79).getContents();
		String Decisionfile = r1.getCell(28, 79).getContents();
		String Decisioncmnt = r1.getCell(29, 79).getContents();
		
		// Document upload data

		String Document_Title_in_list = r1.getCell(7, 79).getContents();
		String Version_in_list = r1.getCell(8, 79).getContents();
		String Document_Date_in_list = r1.getCell(9, 79).getContents();
		String doc_upload = r1.getCell(10, 79).getContents();
		...
		String Decision_LOP1 = r11.getCell(30,79).getContents();
		String Decisionfile1 = r11.getCell(31,79).getContents();
		String Decisioncmnt1 = r11.getCell(32,79).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Query - Full Board");

	}

	// Check for 'Project status' when Continuing submission gets MS decision as 'Query Letter – Reviewers'
	public void CRe4_1458() throws Exception {
		...
		String Decision_LOP = r1.getCell(11, 81).getContents();
		String Decisionfile = r1.getCell(28, 81).getContents();
		String Decisioncmnt = r1.getCell(29, 81).getContents();
		
		// Document upload data

		String Document_Title_in_list = r1.getCell(7, 81).getContents();
		String Version_in_list = r1.getCell(8, 81).getContents();
		String Document_Date_in_list = r1.getCell(9, 81).getContents();
		String doc_upload = r1.getCell(10, 81).getContents();
		...
		String Decision_LOP1 = r11.getCell(30,81).getContents();
		String Decisionfile1 = r11.getCell(31,81).getContents();
		String Decisioncmnt1 = r11.getCell(32,81).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Continuation","Query - Primary Reviewer");
	}
