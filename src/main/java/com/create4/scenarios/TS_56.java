...
//Check for termination submission project status for all MS decisions
public class TS_56 {
	...
	// Check for 'Project status' when Termination submission gets MS decision as 'Letter of permission'
	...
	// *************Termination Script***********************
		...
		String Decision_LOP = r1.getCell(11,91).getContents();
		String Decisionfile = r1.getCell(28,91).getContents();
		String Decisioncmnt = r1.getCell(29,91).getContents();

		// Document upload data
		String Document_Title_in_list = r1.getCell(7,91).getContents();
		String Version_in_list = r1.getCell(8,91).getContents();
		String Document_Date_in_list = r1.getCell(9,91).getContents();
		String doc_upload = r1.getCell(10,91).getContents();
		...
		WebElement termination = GWait.Wait_GetElementByLinkText("Premature Termination");
		termination.click();
		...
		//**************************Normal Flow after Termination document*****************************

		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Submitted to IEC");
		GlobalMethods.Admin_Login();
		gp.Global_Dashboard_PrematureTerminationLink();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Submitted to IEC");
		gp.SubsequentSubmissions_IECAdmin_forwardto_MS();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","MS Review");
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Under IEC Review");
		GlobalMethods.MS_Login();
		gp.Global_Dashboard_PrematureTerminationLink();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","MS Review");
		gp.MS_ForwardTo_CP();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Chairperson Review");
		...
		String Decision_LOP1 = r11.getCell(30,91).getContents();
		String Decisionfile1 = r11.getCell(31,91).getContents();
		String Decisioncmnt1 = r11.getCell(32,91).getContents();
		...
		gp.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Archived","Premature Termination","Approved");
	}

	// Check for 'Project status' when Termination submission gets MS decision as 'Query Letter – Full Board'
	...
	// *************Termination Script***********************
		...
		// Decision upload data
		String Decision_LOP = r1.getCell(11,93).getContents();
		String Decisionfile = r1.getCell(28,93).getContents();
		String Decisioncmnt = r1.getCell(29,93).getContents();

		// Document upload data
		String Document_Title_in_list = r1.getCell(7,93).getContents();
		String Version_in_list = r1.getCell(8,93).getContents();
		String Document_Date_in_list = r1.getCell(9,93).getContents();
		String doc_upload = r1.getCell(10,93).getContents();
		...
		String Decision_LOP1 = r11.getCell(30,93).getContents();
		String Decisionfile1 = r11.getCell(31,93).getContents();
		String Decisioncmnt1 = r11.getCell(32,93).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Query - Full Board");
	
		
	}

	// Check for 'Project status' when Termination submission gets MS decision as 'Query Letter – Reviewers'
	...
	// *************Termination Script***********************
		...
		// Decision upload data
		String Decision_LOP = r1.getCell(11,95).getContents();
		String Decisionfile = r1.getCell(28,95).getContents();
		String Decisioncmnt = r1.getCell(29,95).getContents();

		// Document upload data
		String Document_Title_in_list = r1.getCell(7,95).getContents();
		String Version_in_list = r1.getCell(8,95).getContents();
		String Document_Date_in_list = r1.getCell(9,95).getContents();
		String doc_upload = r1.getCell(10,95).getContents();
		...
		String Decision_LOP1 = r11.getCell(30,95).getContents();
		String Decisionfile1 = r11.getCell(31,95).getContents();
		String Decisioncmnt1 = r11.getCell(32,95).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Query - Primary Reviewer");
	
		
	}

	// Check for 'Project status' when Termination submission gets MS decision as 'Query Letter – MS'
	...
	// *************Termination Script***********************
		...
		// Decision upload data
		String Decision_LOP = r1.getCell(11,97).getContents();
		String Decisionfile = r1.getCell(28,97).getContents();
		String Decisioncmnt = r1.getCell(29,97).getContents();

		// Document upload data
		String Document_Title_in_list = r1.getCell(7,97).getContents();
		String Version_in_list = r1.getCell(8,97).getContents();
		String Document_Date_in_list = r1.getCell(9,97).getContents();
		String doc_upload = r1.getCell(10,97).getContents();
		...
		String Decision_LOP1 = r11.getCell(30,97).getContents();
		String Decisionfile1 = r11.getCell(31,97).getContents();
		String Decisioncmnt1 = r11.getCell(32,97).getContents();
		...
		gp.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Premature Termination","Query - Member Secretary");
