...
//Check for completion 'Document status' until MS decision in PI
public class TS_85 {
	public TS_85() {
	...
	// *************Completion Script***********************
		...
		String Decision_LOP = r1.getCell(26, 229).getContents();
		String Decisionfile = r1.getCell(27, 229).getContents();
		String Decisioncmnt = r1.getCell(28, 229).getContents();
		...
		g5.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","Submitted to IEC");
		GlobalMethods.Admin_Login();
		g5.Global_Dashboard_CompletionLink();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","Submitted to IEC");
		g5.SubsequentSubmissions_IECAdmin_forwardto_MS();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","MS Review");
		...
		g5.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","Under IEC Review");
		GlobalMethods.MS_Login();
		g5.Global_Dashboard_CompletionLink();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","MS Review");
		g5.MS_ForwardTo_CP();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		g5.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","Completion","Chairperson Review");
